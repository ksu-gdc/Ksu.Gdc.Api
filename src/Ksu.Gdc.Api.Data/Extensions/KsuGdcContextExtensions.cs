            ...
            if (!context.Games.Any())
            {
                games.AddRange(new List<DbEntity_Game>()
                {
                    new DbEntity_Game()
                    {
                        ...
                        HostUrl = "https://jessej37.itch.io/overload"
                    },
                    new DbEntity_Game()
                    {
                        ...
                        HostUrl = "https://pi-memorizer.itch.io/operation-inundation"
                    },
                    new DbEntity_Game()
                    {
                        Title = "FPS Prototype",
                        ...
                        HostUrl = "https://crimsonseven.itch.io/pre-alpha-game"
                    },
                    new DbEntity_Game()
                    {
                        Title = "Incursion",
                        Description = "Move with arrow keys. Shoot with Space. Avoid, destroy, and collect health to survive.",
                        HostUrl = "https://crimsonseven.itch.io/incursion"
                    },
                    new DbEntity_Game()
                    {
                        ...
                        HostUrl = "https://studiodingwing.itch.io/furmoji-frenzy"
                    },
                    new DbEntity_Game()
                    {
                        ...
                        HostUrl = "https://pi-memorizer.itch.io/brave-new-worm"
                    }
                });
